...
def main(argv=None):
    ...
    parser = argparse.ArgumentParser(
        description='PyTorch implementation of localization classification',
    ...
    train_sampler = BalancedBatchSampler(train_dataset, n_classes=int(args.n_classes), n_samples=args.batchsize)
    ...
    if eval(args.graph):
        ...
        print('Success in Graph Visualization!')
